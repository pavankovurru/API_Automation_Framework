...
public class MySQL {
    ...
    public static ArrayList query_Post_connection_To_MySQL_Via_JumpServer (String dbQuery , String serviceEndPoint ){
        ...
        if (serviceEndPoint.matches(".*?stage.*?")) {
            ...
            //ssh details
             SSH_USER = "";SSH_PASSWORD = "";SSH_HOSTNAME = "";SSH_PORT = 22;
            //db details
             MY_SQL_HOSTNAME = "";
             DATABASE = "";LOCALPORT = 3366;REMOTEPORT = 3306;DB_USERNAME = "";DB_PASSWORD = "";
        }
        ...
        try {
            ...
            config.put("StrictHostKeyChecking", "no");     //Set StrictHostKeyChecking property to avoid UnknownHostKey issue
        ...
        try {
            ...
            connection = DriverManager.getConnection("jdbc:mysql://localhost:"+LOCALPORT+"/"+DATABASE, DB_USERNAME, DB_PASSWORD);
